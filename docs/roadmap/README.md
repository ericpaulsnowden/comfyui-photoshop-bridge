...
| [realtime-drawing.md](realtime-drawing.md) | M1–M3 + refine R1–R2 SHIPPED (v0.5.45–v0.5.62); M4/M5/R3 not started (updated 2026-07-27) | Draw in Photoshop, get ~1s live ComfyUI re-renders: save-free capture loop → Live Canvas node → result in a docked PS preview panel. Architecture ported from Krita AI Diffusion's proven live mode. |
